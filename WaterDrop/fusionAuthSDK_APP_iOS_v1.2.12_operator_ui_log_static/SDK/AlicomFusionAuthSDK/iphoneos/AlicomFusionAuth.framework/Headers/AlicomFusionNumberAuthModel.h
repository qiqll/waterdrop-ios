...
#pragma mark- 协议详情页
/** 导航栏背景颜色设置 */
@property (nonatomic, strong) UIColor *privacyNavColor __deprecated_msg("listener onProtocolClick callback and use custom webView");
/** 导航栏标题字体、大小 */
@property (nonatomic, strong) UIFont *privacyNavTitleFont __deprecated_msg("listener onProtocolClick callback and use custom webView");
/** 导航栏标题颜色 */
@property (nonatomic, strong) UIColor *privacyNavTitleColor __deprecated_msg("listener onProtocolClick callback and use custom webView");
/** 导航栏返回图片 */
@property (nonatomic, strong) UIImage *privacyNavBackImage __deprecated_msg("listener onProtocolClick callback and use custom webView");
